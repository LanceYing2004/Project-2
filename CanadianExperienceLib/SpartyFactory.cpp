...
std::shared_ptr<Actor> SpartyFactory::Create(std::wstring imagesDir)
{
    ...
    auto pistol = std::make_shared<ImageDrawable>(L"Pistol", imagesDir + L"/pistol_sparty.png");
    pistol->SetCenter(wxPoint(82,78));
    pistol->SetPosition(wxPoint(-75, 130));
    rarm->AddChild(pistol);
