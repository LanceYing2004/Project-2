...
std::shared_ptr<Actor> HaroldFactory::Create(std::wstring imagesDir)
{
    ...
    auto pistol = std::make_shared<ImageDrawable>(L"Pistol", imagesDir + L"/pistol_nobackground.png");
    pistol->SetCenter(wxPoint(68,78));
    pistol->SetPosition(wxPoint(0, 15));
    lhand->AddChild(pistol);
