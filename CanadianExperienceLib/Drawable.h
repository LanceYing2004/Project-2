...
public:
    ...
    /**
     * Display dialog box, specifically for machine drawable
     */
    virtual void DisplayDialogBox() {};

    /**
     * Access dialog box, specifically for machine drawable
     * @param window wxWindow
     */
    virtual void AccessDialogBox(wxWindow* window) {};
